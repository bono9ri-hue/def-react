...
import { Clerk, ClerkOptions, EnvironmentResource } from "@clerk/shared/types";
import { ClerkUIInstance, ComponentControls } from "@clerk/shared/ui";

//#region src/ClerkUI.d.ts
 ...
 * @public
 */
declare class ClerkUI implements ClerkUIInstance {
  #private;
  static version: any;
  version: any;
  /**
   ...
   * @internal
   */
  constructor(getClerk: () => Clerk, getEnvironment: () => EnvironmentResource | null | undefined, options: ClerkOptions, moduleManager: ModuleManager);
  /**
...
//#endregion
export { ClerkUI };
//# sourceMappingURL=ClerkUI.d.ts.map