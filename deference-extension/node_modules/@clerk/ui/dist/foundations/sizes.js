...
//#region src/foundations/sizes.ts
const SPACING_BASE_UNIT = "1rem";
const SPACING_MULTIPLIER = .25;
...
const calcDynamicSpaceUnits = (multiplier) => {
	if (multiplier === 4) return dynamicSpaceUnitsDefaultVar;
...
*/
const BORDER_RADIUS_SCALE_RATIOS = Object.freeze({
	sm: "2 / 3",
	md: "1",
	lg: "4 / 3",
	xl: "2"
...
const radii = Object.freeze({
	...
	sm: clerkCssVar("border-radius-sm", `calc(${radiiDefaultVar} * ${BORDER_RADIUS_SCALE_RATIOS.sm})`),
	md: clerkCssVar("border-radius-md", radiiDefaultVar),
	lg: clerkCssVar("border-radius-lg", `calc(${radiiDefaultVar} * ${BORDER_RADIUS_SCALE_RATIOS.lg})`),
...
//#endregion
export { BORDER_RADIUS_SCALE_RATIOS, radii, sizes, space, spaceScaleKeys };
