...
const NotificationCountBadge = (props) => {
	...
	const enterExitAnimation = (t$1) => ({ animation: shouldAnimate && !prefersReducedMotion ? `${animations.notificationAnimation} ${t$1.transitionDuration.$textField} ${t$1.transitionTiming.$slowBezier} 0s 1 normal forwards` : "none" });
	return /* @__PURE__ */ jsx(Flex, {
		justify: "center",
		align: "center",
		as: "span",
		sx: [(t$1) => ({ marginInlineStart: t$1.space.$1x5 }), containerSx],
