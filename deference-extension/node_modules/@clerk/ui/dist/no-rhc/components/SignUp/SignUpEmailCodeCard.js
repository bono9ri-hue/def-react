...
const SignUpEmailCodeCard = () => {
	...
	useFetch(shouldAvoidPrepare ? void 0 : () => signUp.prepareEmailAddressVerification({ strategy: "email_code" }), {
		name: "prepare",
		strategy: "email_code",
