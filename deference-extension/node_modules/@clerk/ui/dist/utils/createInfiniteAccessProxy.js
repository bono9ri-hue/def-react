//#region src/utils/createInfiniteAccessProxy.ts
/**
...
const createInfiniteAccessProxy = () => {
	const get = (_, prop) => {
		...
		else if (prop in Object.getPrototypeOf("")) return (args) => Object.getPrototypeOf("")[prop].call("", args);
...
//#endregion
export { createInfiniteAccessProxy };
//# sourceMappingURL=createInfiniteAccessProxy.js.map