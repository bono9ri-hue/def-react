...
//#region src/components/devPrompts/shared.tsx
/**
* A container for prompt components
* @internal
*/
function PromptContainer({ children, sx,...props }) {
	return /* @__PURE__ */ jsx(Flex, {
		sx: (t) => [{
			borderRadius: "1.25rem",
			fontFamily: t.fonts.$main,
			background: "linear-gradient(180deg, rgba(255, 255, 255, 0.16) 0%, rgba(255, 255, 255, 0) 100%), #1f1f1f",
			boxShadow: "0px 0px 0px 0.5px #2F3037 inset, 0px 1px 0px 0px rgba(255, 255, 255, 0.08) inset, 0px 0px 0.8px 0.8px rgba(255, 255, 255, 0.20) inset, 0px 0px 0px 0px rgba(255, 255, 255, 0.72), 0px 16px 36px -6px rgba(0, 0, 0, 0.36), 0px 6px 16px -2px rgba(0, 0, 0, 0.20);"
		}, sx],
		...props,
		children
	});
...
* @internal
*/
const basePromptElementStyles = css`
...
`;
function PromptSuccessIcon(props) {
...
function handleDashboardUrlParsing(url) {
	const match = new URL(url).href.match(/^https?:\/\/(.*?)\/apps\/app_(.+?)\/instances\/ins_(.+?)(?:\/.*)?$/);
	if (!match) throw new Error("Invalid value Dashboard URL structure");
	return {
	...
	return /* @__PURE__ */ jsxs("svg", {
		...
		children: [/* @__PURE__ */ jsxs("g", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("feOffset", { dy: "-0.15" }),
				/* @__PURE__ */ jsx("feGaussianBlur", { stdDeviation: "0.15" }),
...
//#endregion
export { ClerkLogoIcon, PromptContainer, PromptSuccessIcon, basePromptElementStyles, handleDashboardUrlParsing };
