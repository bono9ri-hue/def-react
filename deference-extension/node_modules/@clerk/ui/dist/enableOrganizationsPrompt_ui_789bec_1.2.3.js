"use strict";(globalThis.webpackChunk_clerk_ui=globalThis.webpackChunk_clerk_ui||[]).push([["533"],{7334:function(e,i,n){n.r(i),n.d(i,{EnableOrganizationsPrompt:()=>f});var r=n(4518),t=n(4180),o=n(8802),a=n(630),s=n.n(a),l=n(7697),d=n(6705),c=n(9406),p=n(8272),h=n(1986),g=n(8307);let u=({caller:e,onSuccess:i,onClose:n})=>{let s=(0,t.ho)(),[c,u]=(0,a.useState)(!1),[f,b]=(0,a.useState)(!1),[m,C]=(0,a.useState)(null),[v,Y]=(0,a.useState)(!1),y=(0,a.useRef)(null),_=(0,l.O)(),A=(0,a.useId)(),B=!e.startsWith("use"),H=void 0!==_?.organizationSettings.forceOrganizationSelection;return(0,r.Y)(h.Z,{children:(0,r.Y)(d.Modal,{canCloseModal:!1,containerSx:()=>({alignItems:"center"}),initialFocusRef:y,children:(0,r.FD)(g.Uw,{sx:()=>({display:"flex",flexDirection:"column",width:"30rem",maxWidth:"calc(100vw - 2rem)"}),children:[(0,r.FD)(p.so,{direction:"col",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,paddingBottom:e.sizes.$4,gap:e.sizes.$2}),children:[(0,r.FD)(p.so,{as:"header",align:"center",sx:e=>({gap:e.sizes.$2}),children:[(0,r.Y)(F,{isEnabled:f}),(0,r.Y)("h1",{css:[g.mk,(0,o.AH)`
                    color: white;
                    font-size: 0.875rem;
                    font-weight: 500;
                    outline: none;
                  `],tabIndex:-1,ref:y,children:f?"Organizations feature enabled":"Organizations feature required"})]}),(0,r.Y)(p.so,{direction:"col",align:"start",sx:e=>({gap:e.sizes.$0x5}),children:f?(0,r.FD)("p",{css:[g.mk,(0,o.AH)`
                      color: #b4b4b4;
                      font-size: 0.8125rem;
                      font-weight: 400;
                      line-height: 1.3;
                    `],children:[s.user&&m?`The Organizations feature has been enabled for your application. A default organization named "${m}" was created automatically. You can manage or rename it in your`:"The Organizations feature has been enabled for your application. You can manage it in your"," ",(0,r.Y)($,{href:"https://dashboard.clerk.com/~/organizations-settings",target:"_blank",rel:"noopener noreferrer",children:"dashboard"}),"."]}):(0,r.FD)(r.FK,{children:[(0,r.FD)("p",{id:A,css:[g.mk,(0,o.AH)`
                        color: #b4b4b4;
                        font-size: 0.8125rem;
                        font-weight: 400;
                        line-height: 1.23;
                      `],children:["Enable Organizations to use"," ",(0,r.Y)("code",{css:[g.mk,(0,o.AH)`
                          font-size: 0.75rem;
                          color: white;
                          font-family: monospace;
                          line-height: 1.23;
                        `],children:B?`<${e} />`:e})," "]}),(0,r.Y)($,{href:"https://clerk.com/docs/guides/organizations/overview",target:"_blank",rel:"noopener noreferrer",children:"Learn more"})]})}),H&&!f&&(0,r.Y)(p.so,{sx:e=>({marginTop:e.sizes.$2}),direction:"col",children:(0,r.FD)(k,{value:v?"optional":"required",onChange:e=>Y("optional"===e),labelledBy:A,children:[(0,r.Y)(z,{value:"required",label:(0,r.FD)(p.so,{wrap:"wrap",sx:e=>({columnGap:e.sizes.$2,rowGap:e.sizes.$1}),children:[(0,r.Y)("span",{children:"Membership required"}),(0,r.Y)(w,{children:"Standard"})]}),description:(0,r.FD)(r.FK,{children:[(0,r.Y)("span",{className:"block",children:"Users need to belong to at least one organization."}),(0,r.Y)("span",{children:"Common for most B2B SaaS applications"})]})}),(0,r.Y)(z,{value:"optional",label:"Membership optional",description:"Users can work outside of an organization with a personal account"})]})})]}),(0,r.Y)("span",{css:(0,o.AH)`
              height: 1px;
              display: block;
              width: calc(100% - 2px);
              margin-inline: auto;
            ...
            `}),(0,r.Y)(p.so,{justify:"center",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,gap:e.sizes.$3,justifyContent:"flex-end"}),children:f?(0,r.Y)(x,{variant:"solid",onClick:()=>{s.user?i?.():(s.redirectToSignIn(),s.__internal_closeEnableOrganizationsPrompt?.())},children:s.user?"Continue":"Sign in to continue"}):(0,r.FD)(r.FK,{children:[(0,r.Y)(x,{variant:"outline",onClick:()=>{s?.__internal_closeEnableOrganizationsPrompt?.(),n?.()},children:"I'll remove it myself"}),(0,r.Y)(x,{variant:"solid",onClick:()=>{u(!0);let e={enable_organizations:!0};H&&(e.organization_allow_personal_accounts=v),_.__internal_enableEnvironmentSetting(e).then(async()=>{let e=await s.user?.getOrganizationMemberships();C(e?.data[0]?.organization.name??null),b(!0),u(!1)}).catch(()=>{u(!1)})},disabled:c,children:"Enable Organizations"})]})})]})})})},f=e=>(0,r.Y)(c.S,{children:(0,r.Y)(u,{...e})}),b=(0,o.AH)`
  ${g.mk};
  cursor: pointer;
  display: flex;
  align-items: center;
...
`},x=(0,a.forwardRef)(({variant:e="solid",...i},n)=>(0,r.Y)("button",{ref:n,type:"button",css:[b,m[e]],...i})),w=({children:e})=>(0,r.Y)("span",{css:(0,o.AH)`
        ${g.mk};
        display: inline-flex;
        align-items: center;
        ...
        color: #2b2b34;
        white-space: nowrap;
      `,children:e}),[C,v]=(0,t.e3)("RadioGroupContext"),k=({value:e,onChange:i,children:n,labelledBy:t})=>{let o=(0,a.useId)(),l=s().useMemo(()=>({value:{name:o,value:e,onChange:i}}),[o,e,i]);return(0,r.Y)(C.Provider,{value:l,children:(0,r.Y)(p.so,{role:"radiogroup",direction:"col",gap:3,"aria-orientation":"vertical","aria-labelledby":t,children:n})})},Y="1rem",y="0.5rem",z=({value:e,label:i,description:n})=>{let{name:t,value:s,onChange:l}=v(),d=(0,a.useId)(),c=e===s;return(0,r.FD)(p.so,{direction:"col",gap:1,children:[(0,r.FD)("label",{css:(0,o.AH)`
          ${g.mk};
          display: flex;
        ...
        `,children:[(0,r.Y)("input",{type:"radio",name:t,value:e,checked:c,onChange:()=>l(e),"aria-describedby":n?d:void 0,css:(0,o.AH)`
            ${g.mk};
            position: absolute;
            width: 1px;
            height: 1px;
          ...
          `}),(0,r.Y)("span",{css:[g.mk,(0,o.AH)`
              font-size: 0.875rem;
              font-weight: 500;
              line-height: 1.25;
              color: white;
            `],children:i})]}),n&&(0,r.Y)("span",{id:d,css:[g.mk,(0,o.AH)`
              padding-inline-start: calc(${Y} + ${y});
              font-size: 0.75rem;
              line-height: 1.33;
              color: #c3c3c6;
              text-wrap: pretty;
            `],children:n})]})},$=(0,a.forwardRef)(({children:e,css:i,...n},t)=>(0,r.Y)("a",{ref:t,...n,css:[g.mk,(0,o.AH)`
            color: #a8a8ff;
            font-size: inherit;
            font-weight: 500;
            line-height: 1.3;
