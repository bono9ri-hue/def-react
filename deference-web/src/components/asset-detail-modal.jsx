...
export function AssetDetailModal() {
  ...
  return (
    <>
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[9999] bg-white border-8 border-red-500 p-10 pointer-events-none shadow-[0_0_100px_rgba(255,0,0,0.5)] text-center">
        <h1 className="text-6xl text-red-600 font-black tracking-tighter uppercase mb-4">애플바나나 렌더링 테스트</h1>
        <p className="text-xl text-black font-bold">이 화면이 보인다면 파일이 정상적으로 연결된 것입니다.</p>
      </div>
